...
def main():
    ...
    # Run until a collision occurs
    first_collision = run(carts, tracks)

    print("The first collision occurred at: %s" % str(first_collision))
...
def load_map(contents):
    ...
    for y, line in enumerate(contents):
        # Keep track of the width and height of the board.  This is really only
        # relevant for printing the board, could feasibly be removed.
